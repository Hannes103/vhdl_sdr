...
% Code Auszüge
\usepackage{listings}
\lstset{language=VHDL,keywordstyle={\bfseries \color{blue}}}
...
% Tikz
\usepackage{tikz}
\usetikzlibrary{arrows,positioning, calc, shapes.misc, decorations.markings, decorations.pathreplacing, shapes.geometric}
...
\usepackage{pdflscape} % PDF Seiten orientierung
